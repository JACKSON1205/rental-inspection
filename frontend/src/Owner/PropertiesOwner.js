...
// fetch to particular properties edition page, base on properties id
// const toEditpropertyPage = (propertyId) => {
//   window.location = '/owner/property_update_image/' + propertyId;
// }
...
export default function propertiesPage () {
  ...
  React.useEffect(() => {
    ...
    // Make api request to get all properties under this owner
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Button
            ...
            variant="contained"
            color="secondary"
            id="addpropertiesButton"
            className={classes.addpropertiesButton}
            href='/owner/addNewProperty'
          >
            Add
          </Button>
          <GetAllpropertiesInfo loading={loading} properties={properties} />
          <Box pt={4}>
          </Box>
        </Container>
      </main>
...
function GetAllpropertiesInfo (props) {
  const loading = props.loading;
  const properties = props.properties.property_list;
  ...
  if (loading) {
    ...
    return (
      <Grid container spacing={3}>
        {
          // looping to generate and display each properties detail according to property_id
          properties.map(property => (
            <PropertyDetail property={property} key={property.property_id} />
          ))
        }
      </Grid>
    )
...
function PropertyDetail (props) {
  ...
  return (
    <Grid item xs={9}>
      <Link to={'/owner/property_detail/' + property.property_id} style={{ textDecoration: 'none' }}>
        <Paper className={fixedHeightPaper}>
          ...
          <Typography component="body2" variant="h6" color="inherit" align="left" noWrap className={classes.smallContext}>
            Lease Status: {property.leased ? 'Leased' : 'Unleased'}
          </Typography>
          {property.manager_thumbnail !== '' ? <img src={property.manager_thumbnail} width="150" /> : null}
        </Paper>
      </Link>
    </Grid>
  );
