...
import { mainListItems } from '../Manager/Mgr_ListItems';
...
export default function MultiInspectionPage () {
  ...
  class MapProperties extends React.PureComponent {
    constructor (props) {
      ...
      this.endTime = '17:30:00';
      this.inspectionTime = 30;
      this.routeStops = [];
      this.geojson = {};
          ...
          <Grid container spacing={2} justify={'center'}>
            ...
            <Grid item xs={5} className={classes.scheduleForm}>
              { this.state.showScheduleButton
                ? <div>
                    <Typography variant="body1" component="body1" className={classes.dateField}>
              ...
              { this.state.showScheduleButton
                ...
                onClick={(event) => { event.preventDefault(); this.scheduleInspections(); }}
                >
