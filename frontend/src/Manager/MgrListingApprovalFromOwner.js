      ...
      <AppBar position="absolute" className={clsx(classes.appBar, Open && classes.appBarShift)}>
        <Toolbar className={classes.toolbar}>
          ...
          <Typography component="h1" variant="h6" color="inherit" noWrap className={classes.title}>
            Request Listing Property Approval
          </Typography>
          <Button
            id="Profile-button"
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          ...
          <Typography component="h1" variant="h4" align="center">
            Do you approve the property listing request from {propertyDetail.owner_first_name} {propertyDetail.owner_last_name}?
          </Typography>
          <br />
          <br />
...
async function approveRequest (artifactId, clientId) {
  ...
  if (res.status === 200 || res.status === 201) {
    console.log('Request of listing approve');
    sessionStorage.setItem('token', data.token);
