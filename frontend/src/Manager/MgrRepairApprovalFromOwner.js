...
export default function NotificationDetail (props) {
  ...
  React.useEffect(() => {
    ...
    async function getArtifact (ownerId, artifactId) {
      ...
      if (res.status === 200) {
        sessionStorage.setItem('token', data.token);
        setRepairImage(data.artifact.artifact_json.repairing_image);
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          ...
          <Typography component="h1" variant="h4" align="center">
            Do you approve the property maintenance request from {propertyDetail.owner_first_name} {propertyDetail.owner_last_name}?
          </Typography>
          <br />
          <br />
...
// Make api request of accepting connection from owner
