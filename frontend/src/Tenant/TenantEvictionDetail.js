...
export default function EvictionDetail (props) {
  ...
  React.useEffect(() => {
    ...
    async function getNotifications () {
      ...
      if (res.status === 200) {
        ...
        getEvictionDetail(artifactId[notificationIndex]);
    ...
    // Make api request to get eviction detail
    async function getEvictionDetail (artifactId) {
      const options = {
        method: 'GET',
        headers: {
          accept: 'application/json',
      ...
      if (res.status === 200) {
        setEvictionDate(data.artifact_resp.artifact_json.eviction_date);
        sessionStorage.setItem('token', data.token);
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          ...
          <Typography component="h6" variant="h6" align="center">
            Please move out from {propertyDetail.address} before {evictionDate}.
          </Typography>
          <br />
          <br />
