    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          <IconButton type="submit" id="tenantAddContactButton" className={classes.addContactButton} href='/tenant/contact_connect_manager'><AddIcon /></IconButton>
      ...
      <Grid item xs={5}>
        <Paper className={fixedHeightPaper} elevation={5}>
          <Grid container direction="column">
            ...
            <IconButton onClick={ async (event) => { event.preventDefault(); setShow(!show); show ? setJoinResult(await Join(0,)) : setJoinResult(null); } }><ChatIcon /></IconButton>
          </Grid>
        </Paper>
      </Grid>
      <Grid item xs={4}>
