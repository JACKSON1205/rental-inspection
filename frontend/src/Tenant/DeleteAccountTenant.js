...
export default function TenantDeleteAccount () {
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          ...
          <Typography component="body" variant="body">
            Enter your password to delete your account. You will be automatically logged out.
          </Typography>
          <TextField
            variant="outlined"
            margin="normal"
            ...
            type="password"
            autoFocus
            onChange={ (event) => typePassword(event.target.value)}
          />
          <Button
            type="submit"
            variant="contained"
            ...
            onClick={(event) => { event.preventDefault(); deleteAccount(password); }}
          >
            DELETE ACCOUNT
          </Button>
        </Container>
...
async function deleteAccount (password) {
  ...
  if (res.status === 200) {
    ...
    alert('Account sucessfully deleted, redirecting to login page..');
    window.location = '/';
    ...
    console.log('Account deletion fail');
    alert('Account deletion fail');
    sessionStorage.setItem('token', data.token);
  }
}
