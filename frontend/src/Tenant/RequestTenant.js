...
export default function Home () {
  ...
  console.log(propertyList.property_id);
  ...
  React.useEffect(() => {
    ...
    async function getProperties () {
      ...
      if (res.status === 200) {
        sessionStorage.setItem('token', data.token);
        setpropertyList(data.property_list[0]);
      } else if (res.status === 401) {
        console.log('unauthorized: redirecting to login');
        console.log(data.error)
        alert(res.status + ': ' + data.error);
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Button
            ...
            variant="contained"
            color="secondary"
            id="mgrCancelPropertyButton"
            className={classes.RepairButton}
            href={'/tenant/request_repair/' + propertyList.property_id}
          >
            <BuildIcon />
            Request Repair
          </Button>
          <Button
            ...
            href={'/tenant/request_extend_lease/' + propertyList.property_id}
          >
            <HouseIcon />
          ...
          <Button
            ...
            href={'/tenant/request_break_lease/' + propertyList.property_id}
          >
            <DirectionsRunIcon />
            Request Break Lease
          </Button>
